...
public class NoticeDAO implements INoticeDAO{
	...
	// property constants
	public static final String NOTICE_DES = "noticeDes";
	public static final String NOTICE_NAME = "noticeName";
	public static final String NOTICE_PRIORITY = "noticePriority";
	...
	public List findByExample(Notice instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.om.model.Notice")
	...
	public List findByNoticeDes(Object noticeDes) {
		return findByProperty(NOTICE_DES, noticeDes);
	}

	public List findByNoticeName(Object noticeName) {
		return findByProperty(NOTICE_NAME, noticeName);
	}

	public List findByNoticePriority(Object noticePriority) {
		return findByProperty(NOTICE_PRIORITY, noticePriority);
	}
	...
	public List findByPage(int page,int pageNum,int omid) {
		log.debug("finding some List instances");
		try {
			String queryString = "from Notice as model where model.om.omid = '"+omid+"'";
