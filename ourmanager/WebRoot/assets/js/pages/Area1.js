...
function initComplexArea1(a, k, h, p, q, d, b, l) {
    var f = initComplexArea1.arguments;
...
function changeComplexProvince1(f, k, e, d) {
    var c = changeComplexProvince1.arguments; var h = document.getElementById(e);
    var g = document.getElementById(d); var b = 0; var a = 0; removeOptions1(h); f = parseInt(f);
    if (k[f] != undefined) {
    ...
    removeOptions1(g); g[0] = new Option("请选择 ", 0);
